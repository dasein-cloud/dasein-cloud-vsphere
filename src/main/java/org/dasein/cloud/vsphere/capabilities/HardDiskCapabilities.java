 ...
 * Time: 10:30
 */
public class HardDiskCapabilities extends AbstractCapabilities<Vsphere> implements VolumeCapabilities {
    public HardDiskCapabilities(@Nonnull Vsphere provider) {
        super(provider);
    }
